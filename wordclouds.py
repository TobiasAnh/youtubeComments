...
for channel_path in channel_paths:
    ...
    for year in channel_years:
        ...
        plt.axis("off")
        plt.savefig(reports_path.joinpath(channel_foldername, f"WordCloud_{channel_foldername}_{year}.png"), dpi=600)
...
selected_comments_df = pd.read_csv(
    processed_path.joinpath("comments.csv"),
    index_col=0,
    lineterminator="\r",
    parse_dates=["publishedAt", "comment_published"],
)
...
# plt.title(f"YT-Kommentare von {time_window}")
# plt.axis("off")
# plt.savefig(reports_path.joinpath(channel_foldername, f"WordCloud_{channel_foldername}_{picked_videoId}.png"), dpi=600)
